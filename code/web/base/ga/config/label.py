...
HELP_DICT = {
    ...
    'svc_interval_status': 'How often the core service should report its status (in seconds) [min. 60]',
    'svc_interval_reload': 'How often the core service should reload its config (in seconds) [min. 300]',
    'subprocess_timeout': 'The maximum time a device execution should be able to take (in seconds) [min. 1, max. 3600]',
